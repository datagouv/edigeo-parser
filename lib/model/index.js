import {chain, groupBy, isFunction} from 'lodash-es'
...
class Model {
  ...
  _createGraphIndex() {
    this._graphIndex = {}
    for (const relation of this.getItems('LNK')) {
      if (!relation.children || !relation.parent) continue
      for (const child of relation.children) this._createGraphIndexEntry(relation.parent, child, relation.fullId)
    }
  }
