...
function buildFeature(feature, proj, indexedItems, graphIndex) {
...
function buildFeatures(rawFeatures, srsCode, indexedItems, graphIndex) {
  ...
  return rawFeatures
    ...
    .reduce((acc, f) => {
      ...
      acc[ft].push(buildFeature(f, proj, indexedItems, graphIndex))
      return acc
    }, {})
}
