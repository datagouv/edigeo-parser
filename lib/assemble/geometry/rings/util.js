const {first, last, isEqual} = require('lodash')
...
module.exports = {getDistance, getPathLength, positionIsEqual, pathIsClosed, getArcPosition, pathIsEquivalent, touchesExterior}
